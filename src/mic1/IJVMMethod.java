...
//					case mic1.Instruction.NOPARAM:
//						error(lineno, "mic1.Instruction takes no parameters");
//						status = false;
//						break;

//					case mic1.Instruction.BYTE:
//						if (isWide == true) {
...
//					case mic1.Instruction.VARNUM_VARNUM:
...
//						byte_count += 3;
//						break;
//					case mic1.Instruction.LABEL:
//						String label = st.nextToken();
//						inst.setLabel(label);
//						code.addElement(inst);
//						byte_count += 3;
//						break;
//					case mic1.Instruction.OFFSET:
//						const_name = st.nextToken();
//						inst.setLabel(const_name);
//						code.addElement(inst);
//						byte_count += 3;
//						break;
//					case mic1.Instruction.VARNUM_CONST:
...
//					case mic1.Instruction.CONST:
//						break;

//					case mic1.Instruction.INDEX:
//						const_name = st.nextToken();
//						if (const_name.startsWith("=")) {
//							int const_value = Integer.decode(const_name.substring(1))
//									.intValue();
//							int const_count = constants.size();
//							constants.add(new mic1.IJVMConstant(const_name, const_value));
