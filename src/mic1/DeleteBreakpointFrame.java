package mic1;
/****
*mic1.DeleteBreakpointFrame.java
*
...
public class DeleteBreakpointFrame extends RememberPositionJFrame implements ActionListener, Mic1Constants{
   ...
   if (e.getActionCommand() == "OK")
	...
	try{
		...
		{ 
			...
			//new mic1.ErrorDialog("Error","You mast insert a Breakpoint before delete it!!!");
			dispose();
		}
		else {
