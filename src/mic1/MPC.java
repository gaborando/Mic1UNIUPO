...
public class MPC extends TextField {
  ...
  /** Set 9th bit of mic1.MPC as value of mic1.HighBit by shifting the value
      of mic1.HighBit (either 1 or 0) left 8 places and then performing
      a bitwise OR with the value from mic1.O */
  public void poke() {
	value = o_cl.getValue();
