...
public class MainMemoryFrame extends RememberPositionJFrame implements TableModelListener,
	...
	/* select memory word at address mic1.PC */
	int old_index = -1;
	int old_pc = -1;
		...
		if (e.getActionCommand() == "ok") {
			...
			try {
				...
				JOptionPane.showMessageDialog(this,
						...
						"Error format", 2);
				// new mic1.ErrorDialog("error format","The string is not a valid
				...
				JOptionPane.showMessageDialog(this,
						...
						"Error range", 2);
				// new mic1.ErrorDialog("Error range","The start address must be less
				// than 0x3fdff");
				begin = 0;
			}
