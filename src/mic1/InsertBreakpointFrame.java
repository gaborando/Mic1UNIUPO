package mic1; /****
*mic1.InsertBreakpointFrame.java
*
...
public class InsertBreakpointFrame extends RememberPositionJFrame implements ActionListener, Mic1Constants{
  ...
  public void actionPerformed(ActionEvent e)   
   ...
   if (e.getActionCommand() == "OK")
	...
	try{		
		...
		//new mic1.ErrorDialog("error format","The string is not a valid representation of a number");
		begin=0;
		...
		//new mic1.ErrorDialog("Error range","The specify address must be a valid Main Memory addres");
		begin=0;
		}
	 }
