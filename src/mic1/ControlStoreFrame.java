...
public class ControlStoreFrame extends RememberPositionJFrame implements TableModelListener,
		Mic1Constants {
	...
	/* select memory word at address mic1.MPC */
	int old_mpc = -1;
